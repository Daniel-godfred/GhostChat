...
import { AppStatisticsOutputDto } from "../AppStatisticsOutputDto";
import { UserReportOutputDto } from "../UserReportOutputDto";
...
export class AdminResolverBase {
  ...
  @graphql.Query(() => AppStatisticsOutputDto)
  async GetAppStatistics(
    @graphql.Args()
    args: AppStatisticsOutputDto
  ): Promise<AppStatisticsOutputDto> {
    return this.service.GetAppStatistics(args);
  }

  @graphql.Query(() => UserReportOutputDto)
  async GetUserReports(
    @graphql.Args()
    args: UserReportOutputDto
  ): Promise<UserReportOutputDto> {
    return this.service.GetUserReports(args);
  }
}
