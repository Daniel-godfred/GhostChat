...
export class AdminControllerBase {
  ...
  async GetAppStatistics(
    @common.Body()
    body: UserReportOutputDto
  ): Promise<AppStatisticsOutputDto> {
    return this.service.GetAppStatistics(body);
  }

  @common.Get("/reports")
  @swagger.ApiOkResponse({
    type: UserReportOutputDto,
  })
  @swagger.ApiNotFoundResponse({
    type: errors.NotFoundException,
  })
  ...
  async GetUserReports(
    ...
    return this.service.GetUserReports(body);
  }
}
