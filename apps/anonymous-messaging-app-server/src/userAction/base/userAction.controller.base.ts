...
export class UserActionControllerBase {
  ...
  @common.Post("/block-user")
  @swagger.ApiOkResponse({
    type: UserActionInputDto,
  })
  ...
  async IgnoreUser(
    ...
    return this.service.IgnoreUser(body);
  }

  @common.Post("/report-user")
  @swagger.ApiOkResponse({
    type: UserActionInputDto,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async ReportUser(
    ...
    return this.service.ReportUser(body);
  }
}
